...
const removeRicardo = (pessoas) => (
  pessoas.filter((pessoa) => (pessoa !== 'Ricardo'))
);

console.log(removeRicardo(arrayMyStudents));

// MAP
// Percorrendo o array e usando for
const persons = [
...
// Juntando informações de dois arrays
